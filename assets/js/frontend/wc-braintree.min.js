      ...
      return (
          (window.WC_Braintree_Payment_Form_Handler = class {
              ...
              refresh_braintree() {
                  ...
                  const isIntegrationPresent = this.integration !== null;
                  const isNewCardSelected = this.form[0].elements["wc-braintree-credit-card-use-new-payment-method"].checked;
                  const hasInjectedNodes = this.integration ? this.integration._injectedNodes.length : 0;
