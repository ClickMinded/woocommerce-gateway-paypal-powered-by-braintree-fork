  ...
  jQuery(document).ready(function (_) {
      ...
      return (
          (window.WC_Braintree_Payment_Form_Handler = class {
              ...
              render_error(e) {
                  return (
                    _(this.error_class_selector + ", .woocommerce-message").remove(),
                      this.form
              ...
              show_integration_ui() {
                  if ((_(`div.js-wc-${this.id_dasherized}-new-payment-method-form`).find(this.error_class_selector).remove(), _("input#createaccount").length && _("input#createaccount").is(":checked")))
                      return _(`div.js-wc-${this.id_dasherized}-new-payment-method-form`).find(".form-row").show();
              }
              hide_integration_ui() {
                  return (
                      _(`div.js-wc-${this.id_dasherized}-new-payment-method-form`).prepend('<div class="' + this.error_class + '">' + this.integration_error_message + "</div>"),
