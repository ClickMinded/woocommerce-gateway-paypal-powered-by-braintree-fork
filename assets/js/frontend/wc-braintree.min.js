      ...
      return (
          (window.WC_Braintree_Payment_Form_Handler = class {
              ...
              refresh_braintree() {
                ...
                if (typeof this.form[0] !== 'undefined' && typeof this.form[0] === 'object') {
                    if (typeof this.form[0].elements !== 'undefined' && typeof this.form[0].elements === 'object') {
                        isNewCardSelected = isCreditCard ? this.form[0].elements["wc-braintree-credit-card-use-new-payment-method"].checked : false;
                    }else{
                        console.error('The elements property is not defined or is not an object.');
                    }
                }else{
                    console.error('The form object is not defined or is not an object.');
                }
